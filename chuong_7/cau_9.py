...
if __name__ == "__main__":
    # Thêm danh mục
    # Dùng mock ID khác để tránh trùng
    them_danhmuc("DM-U7G8", "Điện thoại")
    them_danhmuc("DM-V9H0", "Laptop")

    # Thêm sản phẩm (mock data mới, tên đã đổi để tránh trùng)
    them_sanpham("SP-A1B2", "Google Pixel 8 Pro", 29990000, "DM-U7G8")
    them_sanpham("SP-C3D4", "Asus ZenBook 14", 32990000, "DM-V9H0")
    them_sanpham("SP-E5F6", "OnePlus 12", 24990000, "DM-U7G8")

    # Tìm kiếm
    print("\n🔍 Tìm sản phẩm 'Pixel':")
    for sp in tim_sanpham("Pixel"):
        print(sp)
